    ...
    public class RepositorioMedicamentos
    {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    var medicamento = new Medicamento()
                    {
                        ...
                        Monodroga = RepositorioMonodrogas.Instancia.Monodrogas.FirstOrDefault(x => x.Nombre == reader["NOMBRE_MONODROGA"])
                    };
        ...
        public bool Agregar(Medicamento medicamento)
        {
            ...
            try
            {
                ...
                command.Parameters.Add("@STOCK_MINIMO", System.Data.SqlDbType.NVarChar, 50).Value = medicamento.Monodroga.Nombre;
